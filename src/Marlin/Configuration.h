...
#define HOTEND_OFFSET_X {0.0, 31.1} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {CONF_X_PULLEY,CONF_Y_PULLEY,400,CONF_FILAMENT_MOTOR}  // default steps per unit for Makergear M2plus
